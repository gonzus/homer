...
int interpreter_operator_declaration(struct ASTNode* n, struct Homer* homer);
int interpreter_operator_function(struct ASTNode* n, struct Homer* homer);
int interpreter_operator_return(struct ASTNode* n, struct Homer* homer);
...
int interpreter_operator_comma(struct ASTNode* n, struct Homer* homer);
